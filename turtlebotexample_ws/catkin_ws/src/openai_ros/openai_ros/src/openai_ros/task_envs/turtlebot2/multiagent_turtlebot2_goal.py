...
register(
        id='MultiagentTurtleBot2-v0',
        entry_point='openai_ros.task_envs.turtlebot2.multiagent_turtlebot2_goal:MultiagentTurtleBot2Env',
...
class MultiagentTurtleBot2Env(multiagent_turtlebot2_env.MultiagentTurtleBot2Env):
    def __init__(self):
        ...
        self.laser_filtered_pub_1 = rospy.Publisher('marobot1/turtlebot2/laser/scan_filtered', LaserScan, queue_size=1)
        self.laser_filtered_pub_2 = rospy.Publisher('marobot2/turtlebot2/laser/scan_filtered', LaserScan, queue_size=1)
        self.laser_filtered_pub_3 = rospy.Publisher('marobot3/turtlebot2/laser/scan_filtered', LaserScan, queue_size=1)
    ...
    def _set_action(self, actions):
        ...
        if action == 0:  # FORWARD
            ...
            linear_speed = -1 * self.init_linear_forward_speed
            angular_speed = 0.0
            self.last_action = "BACKFORWARD"
        elif action == 4:  # STOP
            linear_speed = 0.0
    ...
    def _is_done(self, observations):
        ...
        if self._episode_done:
            ...
            for current_position in [current_position_1, current_position_2, current_position_3]:
                ...
                print("goal_Env_done is:", sub_episode_done)
    ...
    def _compute_reward(self, observations, dones):
        ...
        # reward_all_np = reward_all_np - distance_from_des_points_np
        reward_all_np = reward_all_np - distance_differences_np

        reward_all = reward_all_np.tolist()
        #Situation2: all robots reach desired point
        ...
        has_crashed_all = [self.has_crashed(self.min_laser_value,laser_data_1),self.has_crashed(self.min_laser_value,laser_data_2),self.has_crashed(self.min_laser_value,laser_data_3)]
        j = -1
    ...
    def is_in_desired_position(self, desired_point, current_position, epsilon=0.20):
        """
